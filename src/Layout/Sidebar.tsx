    ...
    <>
      ...
      >
        <div className="p-4 h-full flex flex-col relative">
          ...
          <img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/16765979d7d79cec47b3749d38d9fad83c742608840d468557cb8a2c0aff786d?apiKey=144882928c014ec7a74d06e0b85e9ba9&&apiKey=144882928c014ec7a74d06e0b85e9ba9" alt="Logo" className="object-contain self-stretch my-auto aspect-[3.64] w-[149px]" />
          </div>
              ...
              {navItems.map((item) => (
                <li key={item.name}>
                  <NavLink 
                    ...
                    `}
                  >
                    <img src={item.icon} alt={item.name} className="mr-4 h-5 w-5" /> {/* Change here */}
                    {item.name}
                  </NavLink>
                </li>
              ))}
